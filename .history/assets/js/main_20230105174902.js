...
sr().reveal('.right-content', { delay: 800 });

sr().reveal('.social_icons', { origin: 'left' });

sr().reveal('.left-about',{ delay: 400 }, {origin: 'right'});

sr().reveal('.left-about img, .contact-container .right-contact', { origin: 'right' }, { delay: 800 });
