...
function addItemToTheDOM(product) {
  cartDOM.insertAdjacentHTML("afterbegin",
    ...
    <div class="box">
                 ...
                 <input type="hidden" name="" id="product__id" value="$" />
                <img src="./assets/img/product5.png" alt="" id="image"/>
                  <h3 class="product__name">Cacti Plant</h3>
                <div>
                    
                    <span class="product__price">$89.99</span>
                
                           <i class="add-cart ri-shopping-bag-line"></i>
