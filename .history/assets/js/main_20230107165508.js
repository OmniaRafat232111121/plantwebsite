                ...
                <img src="${product.image}" alt="" id="image"/>
                  <h3 class="product__name">${product.name}</h3>
                     <a class="btn__small" action="decrease">&minus;</a>
                      ...
                      <a class="btn__small" action="increase" onclick="increaseValue()" value="Increase Value" >&plus;</a>
                <div>
...
function increaseValue() {
  //var value = document.querySelector("[action='increase']");
       var value = parseInt(querySelector("[action='increase']").value, 10);
