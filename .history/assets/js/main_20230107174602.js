  ...
  `<div class="box">
                ...
                <img src="${product.image}" alt="" id="image"/>
                  <h3 class="product__name">${product.name}</h3>
                     <a class="btn__small  btn-decrement" action="decrease">&minus;</a>
                      
                      <input class="product__quantity"  id="quantity" value="1" />

                       

                      <a class="btn__small  btn-increment " action="increase" onclick="increase()" >&plus;</a>
                <div>
...
function calculateTotal(){
 ...
 increment.addEventListener("click",()=>{
  let add=  valueCount++;
  count.value=add;
  totalount.innerHTML=add*10255;   //ADDING(INCREMENT) FUCTION IS COMPLETED
   })
