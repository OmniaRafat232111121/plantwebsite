  ...
  `<div class="box">
                ...
                <img src="${product.image}" alt="" id="image"/>
                  <h3 class="product__name">${product.name}</h3>
                     <a class="btn__small btn1 btn-decrement" action="decrease">&minus;</a>
                      
                      <input class="product__quantity"  id="quantity" value="1" />

                       

                      <a class="btn__small btn1 btn-increment " action="increase" >&plus;</a>
                <div>
...
let  totalcount =document.querySelector("##total__counter");
 //NOW AM CREATING A ARROW FUNCTION
 increment.addEventListener("click",()=>{
   let add=  valueCount++;
  count.value=add;
  totalcount.innerHTML=add*10255; 
   })
